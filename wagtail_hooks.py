...
from .models import (
    Logo, Alert, FooterColumn, FooterColumnTwo)
...
class FooterColumnTwoAdmin(ModelAdmin):
    model = FooterColumnTwo
    menu_label = 'Footer Column 2'  
    menu_icon = 'doc-full-inverse'
    list_display = ('footer_col_two_heading', 'footer_col_two')

class HeaderFooterGroup(ModelAdminGroup):
    menu_label = 'Header & Footer'
    menu_icon = 'edit'
    menu_order = 200  
    items = (LogoAdmin, AlertAdmin, FooterColumnAdmin, FooterColumnTwoAdmin)
